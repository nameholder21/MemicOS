# Converts a SAEDashboard MemicOSRunner to a MemicOS export so it can be imported into MemicOS by anyone.
...
def main(
    ...
    command = "python convert-saedashboard-to-memicos-export.py"
