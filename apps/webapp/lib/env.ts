...
// Default Values
export const MEMICOS_EMAIL_ADDRESS = 'johnny@memicos.org';
export const CONTACT_EMAIL_ADDRESS = process.env.NEXT_PUBLIC_CONTACT_EMAIL_ADDRESS || MEMICOS_EMAIL_ADDRESS;
...
//   console.warn(
//     'OPENAI_API_KEY is not set. Search Explanations will not work. Set the key in the file memicos/apps/webapp/.env',
//   );
// }
...
export const IS_ACTUALLY_MEMICOS_ORG =
  process.env.NEXT_PUBLIC_URL === 'https://memicos.org' ||
  process.env.NEXT_PUBLIC_URL === 'https://www.memicos.org';
...
export const ASSET_BASE_URL = 'https://memicos.s3.us-east-1.amazonaws.com/site-assets';
