...
test('steer page loads', async ({ page }) => {
    await page.goto('https://memicos.org/steer');
...
test('deepseek-r1-llama-8b steer', async({ page}) => {
    await page.goto('https://memicos.org/deepseek-r1-distill-llama-8b/steer');
...
test('gemma-2-2b steer', async({ page}) => {
    await page.goto('https://memicos.org/gemma-2-2b/steer');
...
test('gemma-2-2b-it steer', async({ page}) => {
    await page.goto('https://memicos.org/gemma-2-2b-it/steer');
...
//     await page.goto('https://memicos.org/gemma-2-9b/steer');
...
test('gemma-2-9b-it steer', async({ page}) => {
    await page.goto('https://memicos.org/gemma-2-9b-it/steer');
...
test('gpt2-small steer', async({ page}) => {
    await page.goto('https://memicos.org/gpt2-small/steer');
...
test('llama3.1-8b steer', async({ page}) => {
    await page.goto('https://memicos.org/llama3.1-8b/steer');
