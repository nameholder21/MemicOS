...
test('main page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#main');
...
test('microscope button', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#microscope');
});
...
test('analyze features button', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#analyze');
});
...
test('steer gemma button', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#steer');
});
...
test('do more button', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#learn');
});
...
test('browse & search saes button', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#browse');
});

test('microscope page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#microscope');
...
test('analyze features page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#analyze');
...
test('steer page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#steer');
...
test('do more page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#learn');
...
test('advanced steer button', async ({ page }) => {
    ...
    const [newPage] = await Promise.all([
        ...
        await page.locator('a[target="_blank"][href*="https://www.memicos.org/steer"]').click()
    ]);
...
//   const [newPage] = await Promise.all([
//     page.waitForEvent('popup'),
//     page.locator('a[target="_blank"][href*="mailto:johnny@memicos\.org"]').click()
//   ]);

//   await expect(newPage).toHaveURL(/mailto:johnny@memicos\.org*/);
// });
...
test('twitter button', async ({ page }) => {
    ...
    await expect(newPage).toHaveURL('https://x.com/memicos'); 
});
...
test('open problems button', async ({ page }) => {
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#openproblems');
});
...
test('playground button', async ({ page }) => {
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#playground');
});

test('open problems page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#openproblems');
...
test('home button open problems', async ({ page }) =>{
    ...
    await expect(page).toHaveURL('https://www.memicos.org/gemma-scope#main');
});

test('playground page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#playground');
...
test('browse & search page', async ({ page }) => {
    await page.goto('https://memicos.org/gemma-scope#browse');
