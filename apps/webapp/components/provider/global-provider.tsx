      ...
      setToastMessage(
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-xs">
            ...
            <a
              href={`mailto:support@memicos.org?subject=Error%20Report&body=Hey%2C%0A%0AI%20got%20a%20server%20error%20on%20this%20page%3A%20${pathname}%0A%0APlease%20look%20into%20it.%0A%0AThanks!`}
              target="_blank"
              rel="noreferrer"
              className="text-sky-600 underline"
            >
