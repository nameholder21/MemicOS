        ...
        <Accordion type="multiple" defaultValue={evals.map((evalItem) => evalItem.id)} className="w-full">
          {evals.length === 0 ? (
            <div className="flex w-full flex-col items-center justify-center">
              ...
              <a
                href={`mailto:team@memicos.org?subject=Request%20Evals%20for%20${sae.modelId}%2C%20${sae.id}&body=I'd%20like%20to%20request%20evals%20for%20${sae.modelId}%2C%20${sae.id}%20on%20MemicOS.`}
                target="_blank"
                rel="noreferrer"
              >
