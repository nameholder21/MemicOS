      ...
      <Card className="mt-0 w-full max-w-screen-lg bg-white">
        <CardHeader className="w-full pb-3  pt-5">
          <div className="flex w-full flex-row items-center justify-between">
            ...
            <a href="https://docs.memicos.org/search" target="_blank" rel="noreferrer">
              <Button
                variant="outline"
                size="sm"
        ...
        <CardContent className="">
          {model.inferenceEnabled ? (
            ...
            <div className=" flex flex-col items-center justify-center">
              ...
              <a
                href={`mailto:team@memicos.org?subject=Request%20Enabling%20Model%20${model.id}&body=I'd%20like%20to%20request%20that%20MemicOS%20enables%20search%20for%20model%20${model.id}`}
                target="_blank"
                rel="noreferrer"
              >
