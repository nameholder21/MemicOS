    ...
    <form onSubmit={submit}>
      ...
      <div className="mt-2 flex flex-col">
        <label htmlFor="apiKey" className="mt-3 block text-base leading-none">
          <span className="block text-sm leading-none text-slate-600">MemicOS API Key</span>
          <div className="pt-2 text-[11px] font-medium text-slate-400">Private. For accessing MemicOS by API.</div>
