  ...
  return IS_LOCALHOST ? (
    <div className="w-full max-w-xl px-5  xl:px-0 ">
      ...
      <div className="mt-2 text-sm">
        ...
        <br />
        For example, the{' '}
        <a href="https://memicos.org/gpt2-small/res-jb" target="_blank" rel="noreferrer">
          <code className="font-bold text-sky-700 underline">RES-JB</code>
        </a>{' '}
        (link to production MemicOS) SAE Set has 12 SAEs for 12 layers of GPT2-Small, all for the residual stream.
      </div>
