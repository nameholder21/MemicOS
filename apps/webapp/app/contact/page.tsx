        ...
        <Card className="mt-8 w-full bg-white">
          <CardHeader>
            ...
            <CardDescription className="mt-3 pt-2 text-sm">
              MemicOS is constantly evolving for the latest in interpretability science, so your feedback, feature
          ...
          <CardContent className="flex flex-col gap-y-2">
            <p>
              ·{' '}
              <a
                href="https://github.com/hijohnnylin/memicos/issues"
            ...
            <p>
              ...
              <a
                ...
                className="font-bold text-sky-700 hover:underline"
              >
                Slack #memicos or #general
              </a>{' '}
              - Good for quick questions and general tips.
            </p>
            <p>
              ·{' '}
              <a href="mailto:johnny@memicos.org" className="font-bold text-sky-700 hover:underline">
                Email
              </a>{' '}
