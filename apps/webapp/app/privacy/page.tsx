  ...
  return (
    <div className="w-full max-w-screen-md px-3 pt-3 text-sm sm:text-base">
      ...
      <div className="mb-5 text-slate-600">
        MemicOS is built and operated by Decode Research and is fiscally sponsored by Ashgro Inc. Its primary
        contributor is{' '}
      ...
      <div className="pt-3 text-slate-600">
        MemicOS is a new project that aims to accelerate AI interpretability research. It currently has no method or
        plans for monetization. There are no ads, third party trackers, or tracking across different websites.
        <br />
        <br />
        That said, the point of MemicOS is for users to contribute useful data to help explain, understand, and
        build safer AI. In order to do that, MemicOS does need to collect said data, and do things like user
        registration so you can log in. MemicOS uses{' '}
        ...
        things like how many people visit the website. MemicOS also uses Sentry for crash reporting. Sentry does not
        collect any personally identifiable information.
        <br />
        <br />
        If you log in via Github, Apple, or Google, MemicOS saves the email address that you have provided to those
        accounts in order to keep track of your account and send you transactional emails, like emails to reset your
        password. MemicOS uses cookies to ensure you stay logged in. MemicOS does not request any permissions to
        your Github repositories. If you are feeling paranoid, feel free to create a throwaway Github account to log in.
        However, please note that MemicOS cannot merge accounts for you later if you do wish to credit your actual
        Github account with your MemicOS contributions.
        <br />
        <br />
        When you contribute to MemicOS, such as vote on explanations, or add new explanations for a neuron, your
        ...
        <br />
        <br />
        MemicOS caches certain data and results in order to improve response time and avoid strain on our GPUs. For
        ...
        <br />
        <br />
        In order to provide AI researchers with useful data, MemicOS will allow exports of the data you contribute.
        For example, if you add an explanation for a neuron, your explanation may later be exported for analysis by
        researchers. Remember, that is the entire point of the website - to advance AI interpretability. MemicOS
      ...
      <div className=" pb-8 pt-3 text-left text-slate-600">
        <strong>Don&apos;t do illegal stuff.</strong> We&apos;re not sure how you could use MemicOS to do anything
        illegal, but if you figure out a way, don&apos;t do it. Illegal means whatever the laws prohibit in your
        jurisdiction and MemicOS&apos;s (California, USA). This includes things like spamming MemicOS or trying
        to abuse the voting system.
        <br />
        <br />
        <strong>Don&apos;t be mean.</strong> Other people are also on MemicOS, and they presumably want to have an
        enjoyable experience while helping advance AI interpretability. If you are abusive, mean, or harmful to other
        users, you will be banned. MemicOS reserves the right to define harmful behavior.
        <br />
        <br />
        <strong>Warranty.</strong> This website comes with zero warranty and by using it, you agree to not hold
        MemicOS or its creators liable for anything that happens on it. MemicOS does not guarantee that anything
        will work perfectly or even correctly. If you use MemicOS, you are responsible for your actions on
        MemicOS. MemicOS will not protect you if you do silly things like try to harass another user.
      </div>
      ...
      <div className="mb-16 pb-16 pt-3 text-left text-slate-600">
        ...
        <a
          href="mailto:johnny@memicos.org?subject=Privacy%20%26%20Terms%20Question%2FComment&body=Hey%20Johnny%2C%0D%0A%0D%0AHere's%20my%20question%20or%20comment%20about%20the%20privacy%20%2F%20terms%3A%0D%0A%0D%0A%0D%0A%0D%0AThank%20you!%0D%0A"
          className="text-sky-500"
        >
