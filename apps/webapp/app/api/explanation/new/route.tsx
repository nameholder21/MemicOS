...
/**
{
  "/api/explanation/new": {
    "post": {
      ...
      "description": "Upload an explanation for a feature. This the simple version that doesn't upload scoring information. To upload with scoring data, use [`SAELens`](https://github.com/jbloomAus/SAELens), under `sae_lens.analysis.memicos_integration.autointerp_memicos_features`.",
      "requestBody": {
        "required": true,
        "content": {
          "application/json": {
