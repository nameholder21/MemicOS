 ...
 *     description: Generates an explanation for a specific feature using the specified explanation type and model. IMPORTANT- this requires you to set your OpenAI/Anthropic/Google auto-interp API keys under MemicOS Settings.
 *     tags:
 *       - Explanations
 *     security:
 *       - apiKey: []
 ...
 *               explanationModelName:
 *                 type: string
 *                 description: "The name of the model to use for generating the explanation. See full list of supported models in the auto-interpdropdown on a MemicOS dashboard: https://memicos.org/gpt2-small/8-res-jb/55"
 *     responses:
 *       200:
