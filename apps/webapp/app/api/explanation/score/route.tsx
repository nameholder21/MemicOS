 ...
 *     description: Scores an explanation using a specified scoring model and method. IMPORTANT- Your account needs to have an active OpenRouter and/or OpenAI/Gemini/Anthropic key to do this, which you can set up at `https://www.memicos.org/account` once logged in.
 *     tags:
 *       - Explanations
 *     security:
 *       - apiKey: []
