...
export const POST = withAuthedUser(async (request: RequestAuthedUser) => {
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to create features. Please try again or contact support@memicos.org.' },
      { status: 500 },
    );
  }
