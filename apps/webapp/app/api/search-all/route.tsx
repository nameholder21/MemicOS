 ...
 *     description: Returns the top features for a given text input. Equivalent to the https://memicos.org/search functionality. Contact us to increase your rate limit for free if you hit it.
 *     tags:
 *       - Search
 *     security:
 *       - apiKey: []
