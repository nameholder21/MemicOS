 ...
 *     description: Gets activation values for a given feature when processing custom input text. Equivalent to going to a feature page and entering custom text. The example shows this feature https://memicos.org/gpt2-small/9-res-jb/200
 *     tags:
 *       - Features
 *     requestBody:
 *       required: true
