...
import { CLTGraph, makeGraphPublicAccessGraphUri, MAX_GRAPH_UPLOAD_SIZE_BYTES } from './utils';
        ...
        {!isUploadSuccess ? (
          ...
          <div className="mt-1 flex flex-col gap-4">
            <p className="text-sm text-slate-600">
              ...
              <a
                href="https://www.memicos.org/api-doc#tag/circuit-graphs/POST/api/graph/signed-put"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sky-600 hover:underline"
              >
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <div className="text-xs text-amber-700">
                    <p>Uploaded graphs are visible publicly. Your username will be displayed as the author.</p>
                  </div>
                </div>
              </div>
            </div>
