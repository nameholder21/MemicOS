...
class UtilSaeTopkByDecoderCossimPost200ResponseTopkDecoderCossimFeaturesInner(BaseModel):
    """
    UtilSaeTopkByDecoderCossimPost200ResponseTopkDecoderCossimFeaturesInner
    """ # noqa: E501
    feature: Optional[NPFeature] = None
    cosine_similarity: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["feature", "cosine_similarity"]
