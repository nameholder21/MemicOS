...
class SteerCompletionPost200Response(BaseModel):
    """
    The steering/default responses.
    """ # noqa: E501
    outputs: List[NPSteerCompletionResponseInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputs": [NPSteerCompletionResponseInner.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None
        })
        return _obj
