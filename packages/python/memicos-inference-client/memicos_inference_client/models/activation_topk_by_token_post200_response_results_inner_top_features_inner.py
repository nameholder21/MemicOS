...
class ActivationTopkByTokenPost200ResponseResultsInnerTopFeaturesInner(BaseModel):
    """
    ...
    activation_value: Union[StrictFloat, StrictInt] = Field(description="The activation value of this feature at this token position.")
    __properties: ClassVar[List[str]] = ["feature_index", "activation_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activation_value": obj.get("activation_value")
        })
        return _obj
