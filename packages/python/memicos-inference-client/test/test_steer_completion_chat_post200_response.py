    ...
    def make_instance(self, include_optional) -> SteerCompletionChatPost200Response:
        ...
        if include_optional:
            return SteerCompletionChatPost200Response(
                outputs = [
                    memicos_inference_client.models.np_steer_chat_result.NPSteerChatResult(
                        chat_template = [
                            memicos_inference_client.models.np_steer_chat_message.NPSteerChatMessage(
                                content = '', 
                                role = '', )
                            ], 
                        raw = '', 
                ...
                input = memicos_inference_client.models.np_steer_chat_result.NPSteerChatResult(
                    chat_template = [
                        memicos_inference_client.models.np_steer_chat_message.NPSteerChatMessage(
                            content = '', 
                            role = '', )
