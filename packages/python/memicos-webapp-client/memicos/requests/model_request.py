...
class ModelRequest(NPRequest):
    ...
    def new(
        ...
        """
        Create a new model on MemicOS. It will be UNLISTED, meaning that anyone who knows its ID will be able to view it, but it won't be listed publicly in the home page and dropdowns.
        Args:
