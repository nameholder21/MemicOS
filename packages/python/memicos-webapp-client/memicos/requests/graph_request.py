...
class GraphRequest(NPRequest):
    ...
    def upload(
        ...
        """
        Upload a JSON graph to MemicOS.
        """
    ...
    def upload_file(
        ...
        """
        Upload a graph file to MemicOS.

        Args:
            filepath: Local path to the JSON graph file to upload.

        Returns:
            NPGraphMetadata: The metadata for the uploaded graph. Check its url field to see and use the graph on MemicOS, or json_url to get the JSON file.
