...
from memicos.requests.activation_request import Activation


@dataclass
class NPVector:
    """A Vector returned by the MemicOS API."""
    ...
    def steer_chat(self, steered_chat_messages: list[dict[str, str]]):
        # import here to avoid circular import
        from memicos.requests.steer_request import SteerChatRequest
    ...
    def steer_completion(self, prompt: str):
        # import here to avoid circular import
        from memicos.requests.steer_request import SteerCompletionRequest
