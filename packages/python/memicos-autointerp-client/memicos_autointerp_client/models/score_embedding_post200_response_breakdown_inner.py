...
class ScoreEmbeddingPost200ResponseBreakdownInner(BaseModel):
    """
    ...
    similarity: Union[StrictFloat, StrictInt] = Field(description="What is the similarity of the example to the explanation")
    __properties: ClassVar[List[str]] = ["text", "distance", "similarity"]
