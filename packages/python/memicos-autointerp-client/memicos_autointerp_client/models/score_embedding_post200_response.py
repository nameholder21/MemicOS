...
class ScoreEmbeddingPost200Response(BaseModel):
    """
    ScoreEmbeddingPost200Response
    """ # noqa: E501
    score: Union[StrictFloat, StrictInt] = Field(description="The score from 0 to 1")
    breakdown: List[ScoreEmbeddingPost200ResponseBreakdownInner] = Field(description="Detailed breakdown of the embedding outputs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "score": obj.get("score"),
            "breakdown": [ScoreEmbeddingPost200ResponseBreakdownInner.from_dict(_item) for _item in obj["breakdown"]] if obj.get("breakdown") is not None else None
        })
        return _obj
